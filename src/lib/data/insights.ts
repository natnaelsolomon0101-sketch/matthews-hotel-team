...
const baseInsights: Insight[] = [
  {
    ...
    body: [
      ...
      "Select-service is leading. The chain-scale segments where construction lending was effectively closed for the past three years now trade in a 7.75 to 8.50 percent cap range for properties with clean ADR comp sets and renovation reserves funded.",
  ...
  },
  {
    ...
    body: [
      ...
      "Risk factors. The thesis is not without exposure. The energy-cycle markets, Midland, Odessa, Amarillo, carry well-documented commodity-price risk, and this paper excludes them from the core Texas secondary basket. Similarly, university markets concentrate event-week demand to a small number of football weekends and graduation weeks, and that concentration creates RevPAR volatility that does not show in the annualized averages.",
    ].join("\n\n"),
    downloadHref: "#",
  ...
  },
  {
    ...
    body: [
      ...
      "Investment surface. We expect the institutional bid for this category to mature meaningfully in 2026 and 2027, and the cap rates to compress 100 to 150 basis points before that bid is fully priced.",
    ].join("\n\n"),
    downloadHref: "#",
  ...
  },
  {
    ...
    subtitle:
      "Trepp counts $18.7 billion of U.S. hotel CMBS maturing in 2026. What owners need to evaluate now to refinance, sell, or restructure.",
    date: "May 2026",
    authorSlugs: ["luke-thompson", "miles-cortez"],
    cover: "from-[#0e1a34] via-[#1a3a6b] to-[#5d80b8]",
    excerpt:
      "Trepp counts $18.7 billion of U.S. hotel CMBS maturing in 2026, nearly 70 percent of it floating rate (Trepp, via Hotel Dive, August 3, 2026); no public source gives a hotel-specific 2027 figure. For owners who originated debt in the 2017 to 2020 vintage, the refinancing math has changed materially. Underwriting standards are tighter, the in-place cap rate is wider than the cap rate at origination for many assets, and the proceeds-to-pay-off gap is real. Owners need a framework for deciding whether to refinance, sell, or restructure.",
    body: [
      "Trepp counts $18.7 billion of U.S. hotel CMBS maturing in 2026, nearly 70 percent of it floating rate (Trepp, via Hotel Dive, August 3, 2026). No public source gives a hotel-specific 2027 figure, so this piece does not state one. For owners who originated debt in the 2017 to 2020 vintage, the refinancing math has changed materially. Underwriting standards are tighter, the in-place cap rate is wider than the cap rate at origination for many assets, and the proceeds-to-pay-off gap is real. Owners need a framework for deciding whether to refinance, sell, or restructure.",
      ...
      "What to do now. Matthews Hotel Markets prepares free broker opinions of value and arranges hotel refinancing, so an owner facing a 2026 or 2027 maturity can run both paths side by side. The cost of running both paths in parallel is small. The decision-making clarity it produces is large. Owners interested in a confidential look at where their asset prices today should reach out before the maturity calendar dictates the answer for them.",
    ].join("\n\n"),
    downloadHref: "#",
    tags: [
      "Refinancing",
  ...
  },
  {
    ...
    body: [
      ...
      "The pattern we are hearing. Hotel investors who deployed into primary urban metros in the 2018 to 2022 vintage are looking at Sun Belt secondary for the next vintage. The driver is not nostalgia for a regional thesis. It is the cap rate spread. Stabilized PIP-current select-service in Tyler, Lubbock, College Station, Waco, Mobile, Knoxville, and Greenville prices 75 to 125 basis points wider than the same asset in Austin, Nashville, or Atlanta primary metros. The yield premium is real, the operating economics in those markets have outperformed primary metros on RevPAR recovery through 2024 and 2025, and the new-supply pipeline is constrained by the 2022 to 2024 construction-loan freeze.",
      "Family-office capital is the most active. The fastest-moving capital in the Sun Belt secondary today is family-office. The institutional fund consensus remains anchored in primary metros for liquidity and exit-comp reasons. Family-office capital does not face the same constraint, deploys more flexibly, and is willing to underwrite longer hold periods.",
