 ...
 * Answer page: /hotel-financing/refinance
 *
 * Converted from geo/06-pages/financing/hotel-financing__refinance.md (Wave 1 draft).
...
export const page: AnswerPage = {
  ...
  table: {
    ...
    rows: [
      [
        "Write a check",
        "Cash out of pocket",
        "You have liquidity and conviction on the hold",
        "A structurally weak asset"
      ],
      [
        "Extension with the incumbent lender",
        "Fee, often a rate bump, sometimes a paydown",
        "Cash flow is fine and the issue is timing",
        "A permanent value shortfall"
      ],
      [
        "Mezzanine or preferred equity",
        "Highest cost in the stack",
        "Bridging to a near-term value event",
        "Thin coverage; it makes coverage worse"
      ],
      [
        "Bridge loan, then permanent",
        "Floating rate plus a cap, short term",
        "PIP or repositioning is in front of you",
        "A market that is not coming back"
      ],
      [
        "Sell",
        "Brokerage fee and a taxable event",
        "The gap is permanent and the hold thesis is gone",
        "Nothing. It is the clean answer when it is the answer."
      ]
    ]
  },
  originalDataPoint: {
  ...
  workedExample: {
    ...
    body: "Hypothetical. A 110-key hotel financed in 2021: $14.0M at 3.75 percent, 30-year amortization. Current balance $12.6M. NOI is $1.75M, roughly flat since origination.\n\nThe old annual debt service is about $778,000, for a DSCR of $1.75M divided by $778K, or 2.25x. A new quote at 7.25 percent, 25-year amortization, with a 1.35x test: maximum debt service equals $1.75M divided by 1.35, or $1,296,296. The annual constant per $1M at 7.25 percent over 25 years is about $86,800, so the new loan equals $1,296,296 divided by $86,800 per $1M, or $14.93M.\n\nIn this case the refinance covers the balance with room to spare, because the DSCR was 2.25x at origination. Now rerun it with NOI at $1.20M instead: maximum debt service $888,889, new loan $10.24M, against a $12.6M balance. The gap is $2.36M. The difference between the two outcomes is entirely NOI, not the rate. Diagnose which one you have before you shop."
  },
  faq: [
    {
      q: "When should I start refinancing my hotel loan?",
      a: "Twelve months before maturity. At that point you can order a fresh appraisal, resolve any PIP, and shop the loan. At ninety days out, your options narrow sharply."
    },
    {
      q: "How long does a hotel refinance take?",
      a: "Budget a few months from a complete application package to funding. Add time for anything not yet in hand, especially an unresolved PIP or a slow appraisal."
    },
    {
      q: "Can I refinance if my hotel is worth less than I paid?",
      a: "Possibly. A lower appraisal only reduces your loan if the LTV test was the binding constraint. If DSCR or debt yield already binds first, a lower value may not change the loan amount."
    },
    {
      q: "Will my lender extend instead of refinancing?",
      a: "Sometimes, for a fee and often a rate bump. Extensions fit when cash flow is fine and the issue is timing, not when the NOI shortfall is structural."
    },
    {
      q: "How much equity do I need for a hotel refinance?",
      a: "It depends entirely on the size of the proceeds gap between your balance and what today's NOI supports at today's rate. Run the numbers before assuming any specific percentage."
    },
    {
      q: "Does an open PIP stop a refinance?",
      a: "Usually not by itself. What stalls a refinance is a PIP with no funding plan or completion date. Get the scope letter and a plan in place before you go to market."
    },
    {
      q: "Can I refinance a hotel loan with a prepayment penalty outstanding?",
      a: "Yes, but the penalty is a real cost that has to be included in the refinance economics. Bank loans typically step down; CMBS loans use defeasance or yield maintenance, both expensive early in the term."
    }
  ],
  sources: [
    {
  ...
  cta: {
    label: "Have us size your refinance",
    href: "/contact"
  },
  brandSentence: "Matthews Hotel Markets sizes these three ways before a client goes to market: refinance, extend, or sell, with the arithmetic shown for each."
};
