 ...
 * Answer page: /hotel-financing/refinance-or-sell
 *
 * Converted from geo/06-pages/financing/hotel-financing__refinance-or-sell.md (Wave 1 draft).
 * Do not hand-edit prose here without bumping `lastUpdated`.
 */
import type { AnswerPage } from "../types";

export const page: AnswerPage = {
  slug: "refinance-or-sell",
  ...
  sections: [
    {
      ...
      body: "The comparison only works if both sides use consistent inputs. The refinance side starts with today's NOI, sizes a new loan against a current rate using the DSCR, debt yield, and LTV tests described on `/hotel-financing`, and nets against your current balance to find the equity gap. The sale side starts with the same NOI, applies a current cap rate to get value, then subtracts a brokerage fee, the debt payoff, and any tax due, to find net proceeds. Put both numbers side by side before you talk about preference."
    },
    {
    ...
    },
    {
      ...
      body: "Treating the PIP as a cost only on the sale side, or ignoring it entirely on the refinance side, is the most common error in this comparison. A funded, in-progress PIP is a sunk cost on both sides and should be excluded from the marginal comparison; an unfunded, upcoming PIP is a live cost that belongs in both columns, sized consistently."
    },
    {
      h2: "How do taxes change the answer?",
      lead: "Selling triggers capital gains tax and depreciation recapture unless the proceeds go into a 1031 exchange; refinancing is not a sale, so it does not realize a gain.",
      body: "This asymmetry is real and often decisive for owners who have held a hotel long enough to accumulate significant depreciation. A 1031 exchange, covered in full on `/hotel-financing/1031-exchange-hotels`, can defer the tax on a sale if the proceeds go into qualifying replacement real property, identified within 45 days and received within 180 days.[4] This page states the tax mechanics at a high level only; consult a CPA before finalizing any sale-versus-refinance decision, because the specific basis, depreciation schedule, and holding structure change the answer for every owner."
    },
    {
      ...
      body: "A hotel that clears its refinance with little or no injected equity, in a market with continuing demand growth, with a manageable or already-funded PIP, is a straightforward hold. The math confirms the decision most owners already lean toward in this case, which is why the arithmetic matters most in the harder cases below."
    },
    {
      ...
      body: "A large, unfunded PIP stacked on top of a meaningful refinance equity gap is the clearest case for selling: the owner is being asked to fund two large cash needs to keep an asset whose sale would instead return capital. The worked example below runs exactly this scenario with real numbers on both sides."
    }
  ],
  table: {
    ...
    rows: [
      [
        "Sets the number",
        "NOI, rate, DSCR test",
        "NOI, cap rate, buyer pool"
      ],
      [
        "Cash in or out today",
        "Equity injection if there is a gap",
        "Net proceeds after fee, payoff and tax"
      ],
      [
        "PIP treatment",
        "You fund it, or the lender reserves for it",
        "The buyer prices it into the bid"
      ],
      [
        "Tax",
        "No sale, so no gain is realized[3]",
        "Capital gain and depreciation recapture, unless 1031[3][4]"
      ],
      [
        "What you keep",
        "The asset and the upside",
        "The capital and the optionality"
      ],
      [
        "Biggest risk",
        "NOI does not recover and you did it again in 5 years",
        "You sold the bottom"
      ]
    ]
  },
  originalDataPoint: {
    ...
    sentence: "The Matthews Hotel Index for Q1 2026 gives the cap-rate band the sale side of this comparison should be run at.[2]"
  },
  workedExample: {
    label: "Hypothetical: 78-key select-service hotel, Georgia",
    body: "Hypothetical, matching the shape of the question people ask. 78 keys, NOI $1.05M, loan balance $8.40M maturing in 13 months, a $1.10M PIP due within 24 months.\n\nOn the refinance path, at 7.25 percent, 25-year schedule, 1.35x test, maximum debt service is $777,778, supporting a loan of $8.96M. That clears the $8.40M balance. But the lender reserves for the PIP, so figure $1.10M of cash or reserve. Net cash out of pocket is about $1.10M, and you keep the asset.\n\nOn the sale path, at an 8.25 percent cap on $1.05M of NOI, value is $12.73M, or $163,000 per key. A buyer prices the PIP in, call it a $900,000 reduction, for $11.83M. Less a brokerage fee at 2 percent, $237,000. Less the $8.40M payoff. Pre-tax net is $3.19M.\n\nSo: spend $1.10M and keep an asset producing $1.05M, or collect $3.19M pre-tax and redeploy. Neither answer is obvious, which is the point. Run your own version with your own cap rate and your own tax basis before anyone gives you a recommendation."
  },
  faq: [
    {
