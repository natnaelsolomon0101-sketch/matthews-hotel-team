...
export const page: AnswerPage = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "The length of the diligence period is a negotiated term of the purchase agreement, so the contract you sign sets your real deadline. [How to make an offer on a hotel](/buy-a-hotel/how-to-make-an-offer) reads three signed hotel agreements to show how short that window tends to be. The slow items are the ones with outside parties: the brand, the liquor authority, the lender's appraisal and the third-party reports. Order the property condition assessment, the survey and the Phase I in the first week, file the franchise application at signing, and leave the last weeks for negotiating what the reports found. The seller's view of the same calendar is at [How long does it take to sell a hotel?](/sell-a-hotel/how-long-it-takes), and the documents a seller should hand over are listed at [Documents needed to sell a hotel](/sell-a-hotel/documents-needed)."
    }
  ],
  table: {
