...
export const draft: Insight = {
  ...
  body: [
    ...
    "The path that has clarified materially in Q1 and Q2 2026. The bid for stabilized PIP-current select-service is tight enough now that selling at the new cap rate frequently produces a better outcome than writing a fresh equity check. The arithmetic: if the proceeds gap on refinance is 15 percent of the outstanding balance, and the sale produces a 6 percent net-of-fee residual on top of debt payoff, the sponsor is recovering equity worth roughly the same gap with the upside of redeploying into a new vintage at current cap rates. This path fits assets where the owner's forward RevPAR view is moderate rather than aggressive, and where the brand-standard PIP would consume any equity injection within 18 months anyway. Matthews Hotel Markets sells hotels nationwide, including the [Texas Triangle](/markets/austin-tx), the [Sun Belt secondary basket](/markets/nashville-tn), and the [Mountain West corridor](/markets/denver-co).",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Matthews Hotel Markets prepares free BOVs (Broker Opinion of Value) and arranges hotel refinancing, so an owner facing a 2026 or 2027 maturity can compare both paths. Reach out to Luke Thompson (Capital Markets, Austin) or Miles Cortez (Capital Markets, Denver) for a confidential evaluation. Both paths in parallel produces decision-making clarity at low marginal cost.",
    },
  ],
  sources: [
    {
