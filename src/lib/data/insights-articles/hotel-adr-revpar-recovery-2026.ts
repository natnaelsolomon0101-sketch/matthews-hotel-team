...
export const draft: Insight = {
  ...
  body: [
    ...
    "Phoenix and Scottsdale. A Scottsdale March 2026 RevPAR figure that previously appeared here was removed on September 17, 2026: it traced to an aggregator rather than to STR or CoStar hotel benchmarking, and it looks like short-term-rental data rather than hotel data. We do not have a sourced Scottsdale RevPAR print to replace it with, so this section states the demand drivers and the forecast without one. Spring training (Cactus League), the WM Phoenix Open, and Barrett-Jackson auction drive Q1 compression. Intel Ocotillo expansion and the TSMC Phoenix campus add structural corporate demand to Tempe and Chandler select-service. Base case: +3.0 to +5.0 percent RevPAR for Scottsdale resort; +1.5 to +3.0 percent for Phoenix urban select-service.",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Supply-constrained leisure: Charleston historic district ($300-450 peak), Miami Beach lifestyle/luxury ($400-1,200+ peak), Scottsdale resort, Nashville downtown ($220-280 stabilized), Riverwalk San Antonio ($180-240 stabilized). The common thread is that new construction in the historic core or beachfront/resort footprint is structurally difficult.",
    },
    {
