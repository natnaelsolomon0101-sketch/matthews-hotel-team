...
export const draft: Insight = {
  ...
  tldr: [
    ...
    "AHLA's public 2026 State of the Industry release forecasts U.S. hotel guest spending of nearly $805 billion in 2026, up 1.7 percent over 2025 (AHLA, read 2026-09-17). A sold-room-nights forecast previously cited here was removed on September 17, 2026: it is not in that public release, which publishes guest spending, tax contribution, wages, employment and GOPPAR rather than room nights.",
  ...
  keyStats: [
    ...
    {
      value: "$805B",
      label: "AHLA forecast U.S. hotel guest spending, 2026 (+1.7% YoY)",
      source: "AHLA 2026 State of the Industry, public release",
    },
    {
      value: "108.1M",
