...
export const STATS: Stat[] = [
  ...
  },
  {
    ...
    group: "sba",
    text: "A hotel is a limited or special purpose property under 13 CFR 120.910, so the borrower must contribute at least 15% of project cost, capping a 504 structure at 85% of cost.",
  ...
  },
  {
    id: "sba-504-max",
    group: "sba",
    text: "The maximum 504 loan is $5.5 million, and 10, 20 and 25 year maturities are available.",
    sourceName: "504 loans",
    publisher: "U.S. Small Business Administration",
