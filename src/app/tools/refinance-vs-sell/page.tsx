...
import { page as tool } from "@/lib/data/tools/refinance-vs-sell";
import { page as paired } from "@/lib/data/answers/hotel-financing/refinance-or-sell";
import ToolIsland from "../ToolIsland";
import ToolExtras from "../ToolExtras";

export const metadata: Metadata = answerMetadata(tool, "/tools/refinance-vs-sell");
...
export default function Page() {
  return (
    <AnswerPageView
      ...
      island={
        <>
          <ToolIsland kind="refinance-vs-sell" tool={tool.tool} />
          <ToolExtras
            page={tool}
            paired={{ href: "/hotel-financing/refinance-or-sell", label: paired.h1 }}
          />
        </>
      }
    />
